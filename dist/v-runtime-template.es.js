...
var index = {
  ...
  render: function render(h) {
    ...
    var $parent = this.$props.parent || this.$parent;
    var $data = $parent.$data; if ( $data === void 0 ) $data = {};
    var $props = $parent.$props; if ( $props === void 0 ) $props = {};
    var $options = $parent.$options; if ( $options === void 0 ) $options = {};
    ...
    var methodsFromProps = buildFromProps($parent, methodKeys);
